...
図2では、ギャップ長が短くなっても、平均火花電圧は理論曲線のように大きくならないことがわかる。
球-球電極で低気圧だと電界が一様にならないと仮定する。
この場合、単純に最も距離が近い、球の先端と球の先端が火花のチャネルとなりやすいと思われる。
したがって、そのチャネルに十分な気体分子が存在する瞬間、火花が起きると考えられる。
また、気圧が十分に大きい場合、
...
気圧が100Paのとき、電流ー電圧特性の関係は、直線の微小ではあるが、正の比例の関係にあると考えられる。
...
しかしながら、おおよそは一定であり、正規グローの範囲内であると推測できる。
